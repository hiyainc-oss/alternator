...
> **Note**: As of version 0.12.0, Akka modules have been replaced with Apache Pekko. Pekko is an open-source fork of Akka 2.6 maintained by the Apache Software Foundation, providing the same API without licensing concerns.
...
> **Apache Pekko:** Apache Pekko is an open-source fork of Akka 2.6 maintained by the Apache Software Foundation. Alternator uses Pekko instead of Akka to avoid licensing concerns while maintaining the same streaming capabilities.
