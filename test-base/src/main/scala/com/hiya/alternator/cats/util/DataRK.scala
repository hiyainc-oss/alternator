...
object DataRK {
  ...
  implicit val config: TableConfig[DataRK, (String, String), TableWithRangeLike[*, DataRK, String, String]] =
    new TableConfig[DataRK, (String, String), TableWithRangeLike[*, DataRK, String, String]] {
      override def withTable[F[_], S[_], C](client: C): TableConfig.Partial[F, S, C, TableWithRangeLike[*, DataRK, String, String]] =
        new TableConfig.Partial[F, S, C, TableWithRangeLike[*, DataRK, String, String]] {
          override def source[T](f: TableWithRangeLike[C, DataRK, String, String] => S[T])(
            implicit dynamoDB: DynamoDB[F, S, C]
          ): S[T] = {
          ...
          override def eval[T](f: TableWithRangeLike[C, DataRK, String, String] => F[T])(
            implicit dynamoDB: DynamoDB[F, S, C], F: Monad[F]
          ): F[T] = {
