...
import com.hiya.alternator.alpakka.AlpakkaTableOpsWithRange
import com.hiya.alternator.syntax.RKCondition
import com.hiya.alternator.{DynamoFormat, TableWithRangeKey}
import software.amazon.awssdk.services.dynamodb.DynamoDbAsyncClient

class AlpakkaTableOpsWithRangeInternal[V, PK, RK](override val table: TableWithRangeKey[V, PK, RK])(implicit client: DynamoDbAsyncClient, system: ClassicActorSystemProvider)
  extends AlpakkaTableOpsInternal[V, (PK, RK)](table) with AlpakkaTableOpsWithRange[V, PK, RK] {
